...
# 1. KRİTİK DOKUNUŞ: layout="wide" yaparak ekranı tam genişlikte kullanıyoruz
...
with sag_kolon:
    # 2. KRİTİK DOKUNUŞ: Sağ tarafı sonuç ekranı ve bilgi paneli yaptık
    ...
    # Mühendislik detayları yine sağda, sonuçların hemen altında kalacak
    st.divider()
